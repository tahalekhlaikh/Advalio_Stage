  ...
  <tbody>
    ...
    <tr>
        <tr>
          ...
          <tr>
            <td>Quantité du bon commandée</td>
            <td class="bg-success">{{$interval}}</td>
           <td class="bg-success"></td>
          </tr>
          <tr>
            <td>Quantité consommée du BC</td>
            <td class="bg-warning">{{$consommée}}</td>
    ...
    <tr>
      <td>Quantité Restante du BC</td>
      <td class="bg-warning">{{$restante}}</td>
     <td class="bg-warning"></td>
