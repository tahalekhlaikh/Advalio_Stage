    ...
    <div class="col-xl-3 col-sm-6 mb-3">
      <div class="card text-white bg-primary o-hidden h-100">
        <div class="card-body">
          ...
          <div class="mr-5">{{$No_jour_mois}} Jours De Travail!</div>
        </div>
...
<div class="row">
  <div class="col-xl-3 col-sm-6 mb-3">
    <div class="card text-white  o-hidden h-100 blue">
      <div class="card-body">
        ...
        <div class="mr-5">{{$No_jour_conjé_payé}} Jours Congés Payé!</div>
  ...
  <div class="col-xl-3 col-sm-6 mb-3">
    <div class="card text-white  o-hidden h-100 orange">
      <div class="card-body">
        ...
        <div class="mr-5">{{$No_jour_conjé_sans_solde}} Jours Congés Sans solde!</div>
  ...
  <div class="col-xl-3 col-sm-6 mb-3">
    <div class="card text-white  o-hidden h-100 pink">
      <div class="card-body">
        ...
        <div class="mr-5">{{$No_jour_Frais_généraux}} Jours Frais généraux!</div>
  ...
  function Select_mois()
  {
           ...
           location.href="/salarié/select/"+id+"/month";
