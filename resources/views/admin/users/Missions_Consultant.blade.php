...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <div class="container">
    ...
    <form action="{{url('admin/users/CreateMission_Consultant',$user->id)}}" method="POST">
        @csrf
  ...
  <tbody>
    ...
    <tr>
        <tr>
            ...
            <td><input type="text" class="form-control" name="Intitulé_Mission"  placeholder="Intitulé_Mission"  required autocomplete="Intitulé_Mission" autofocus></td>
           <td></td>
          </tr>
          <tr>
            <td>Responsable</td>
          ...
          <tr>
            ...
            <td><input type="date" class="form-control" name="Date_Debut"  placeholder="Date Debut de Mission"  required autocomplete="Date Debut de Mission" autofocus></td>
           <td></td>
          </tr>
      <td>Numéro de Bon Commande En cours</td>
      <td><input type="text" class="form-control" name="numéro_Bncmd_encours"  placeholder="Numéro de Bon Commande En cours"  required autocomplete="Numéro de Bon Commande En cours" autofocus>
        <tr>
          <td>Date Fin de Mission</td>
          <td><input type="date" class="form-control" name="Date_Fin"  placeholder="Date Fin de Mission"  required autocomplete="Date Debut de Mission" autofocus>
            <input type="hidden" name="Users[]" value="{{$user->id}}"></td></td>
         <td></td>
        </tr>             
